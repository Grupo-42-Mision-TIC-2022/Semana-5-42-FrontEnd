    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar text color="white">
                ...
                <v-dialog v-model="dialog" max-width="500px">
                    <template v-slot:activator="{ on }">
                        <v-btn color="deep-purple lighten-1" dark class="mb-2" v-on="on">Nuevo Artículo</v-btn>
                    </template>
                    <v-card>
                        <v-card-title>
                        ...
                        <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="deep-purple lighten-3 "  @click="close">Cancelar</v-btn>
                        <v-btn color="deep-purple lighten-3 "  @click="guardar">Guardar</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-dialog>
                <v-dialog v-model="adModal" max-width="290">
                    <v-card>
                        ...
                        <v-card-text>
                            Confirma que el siguiente servicio <span v-if="adAccion==1"> será activado </span>
                            <span v-if="adAccion==2">será desactivado </span> :  {{adNombre}}
                        </v-card-text>
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn @click="activarDesactivarCerrar()" color="cyan" >
                                Cancelar
                            </v-btn>
                            <v-btn v-if="adAccion==1" @click="activar()" color="cyan" >
                                Activar
                            </v-btn>
                            <v-btn v-if="adAccion==2" @click="desactivar()" color="cyan" >
                                Desactivar
                            </v-btn>
                        </v-card-actions>
                    </v-card>
            ...
            <template v-slot:[`item.estado`]="{ item }">
                ...
                <v-btn color="primary" @click="listar()">Sin permiso para acceder</v-btn>
                </template>
            </v-data-table>
        </v-flex>
    </v-layout>
        ...
        data(){
            return{
                ...
                headers: [
                    ...
                    { text: 'Acciones', value: 'opciones', sortable: false, width: "100px", fixed: true  }
                ],
                id:'',
                editedIndex: -1,
                categoria:'',
