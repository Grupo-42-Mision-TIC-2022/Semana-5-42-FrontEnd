            ...
            <v-toolbar text color="white">
                ...
                <v-dialog v-model="dialog" max-width="500px">
                    <template v-slot:activator="{ on }">
                        <v-btn color="deep-purple lighten-3" dark class="mb-2" v-on="on">Nuevo Usuario</v-btn>
                    </template>
                    <v-card>
                        <v-card-title>
                ...
                <v-dialog v-model="adModal" max-width="290">
                    <v-card>
                        ...
                        <v-card-text>
                            Confirma <span v-if="adAccion==1">activar </span>
                            <span v-if="adAccion==2">desactivar </span> el usuario: {{adNombre}}
                        </v-card-text>
                        <v-card-actions>
                            <v-spacer></v-spacer>
        ...
        data(){
            return{
                ...
                headers: [
                    ...
                    { text: 'Opciones', value: 'opciones', sortable: false , width: "100px", fixed: true }
                ],
                id:'',
                editedIndex: -1,
                nombre:'',
